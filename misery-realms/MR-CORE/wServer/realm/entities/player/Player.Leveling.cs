...
namespace wServer.realm.entities
{
    public partial class Player
    {
            ...
            new Dictionary<string, Tuple<int, int, int>>()  //Priority, Min, Max
        {
            ...
            { "Lich",                           Tuple.Create(8, 6, 13) },
            { "Actual Lich",                    Tuple.Create(8, 7, 13) },
            { "Ent Ancient",                    Tuple.Create(9, 7, 14) },
            { "Actual Ent Ancient",             Tuple.Create(9, 7, 14) },
            { "Oasis Giant",                    Tuple.Create(10, 8, 16) },
            { "Phoenix Lord",                   Tuple.Create(10, 9, 16) },
            { "Ghost King",                     Tuple.Create(11,10, 16) },
            { "Actual Ghost King",              Tuple.Create(11,10, 17) },
            { "Cyclops God",                    Tuple.Create(12,10, 17) },
            { "Kage Kami",                      Tuple.Create(12,10, 17) },
            { "Red Demon",                      Tuple.Create(13,15, 17) },
            ...
            { "The Nightmare",                  Tuple.Create(17,1, 20) },
