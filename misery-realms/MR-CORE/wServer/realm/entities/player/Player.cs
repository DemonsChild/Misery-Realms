...
namespace wServer.realm.entities
{
    ...
    public partial class Player : Character, IContainer, IPlayer
    {
        ...
        private readonly SV<string> _guildTag;
        public string GuildTag
        {
            get { return _guildTag.GetValue(); }
            set { _guildTag.SetValue(value); }
        }
        ...
        protected override void ImportStats(StatsType stats, object val)
        {
            ...
            switch (stats)
            {
                ...
                case StatsType.GuildTag: GuildTag = (string)val; break;
            ...
            : base(client.Manager, client.Character.ObjectType)
        {
            ...
            _guildTag = new SV<string>(this, StatsType.GuildTag, "");
        ...
        void HandleRegen(RealmTime time)
        {
            ...
            {
                _hpPotRegenCounter += Stacks[0].MaxCount * time.ElapsedMsDelta / 120000f;
        ...
        private void AnnounceDeath(string killer)
        {
            ...
            var deathMessage = string.Format(
                "{0} was slain by {4} [level: {1}, base fame: {2}, maxed: {3}]",
                Name, Level, _client.Character.Fame, maxed, killer);
