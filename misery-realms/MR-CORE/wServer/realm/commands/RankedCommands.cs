...
namespace wServer.realm.commands
{
    class SpawnCommand : Command
    {
        ...
        public SpawnCommand() : base("spawn", permLevel: 4) { }
    ...
    {
        public ClearSpawnsCommand() : base("clearspawn", permLevel: 4, alias: "cs") { }
    ...
    {
        public ClearGravesCommand() : base("cleargraves", permLevel: 4, alias: "cgraves") { }
    ...
    {
        public ToggleEffCommand() : base("eff", permLevel: 4) { }
    ...
    class AdminBuffCommand : Command
    {
        public AdminBuffCommand() : base("adminbuff", permLevel: 5) { }

        protected override bool Process(Player player, RealmTime time, string args)
        {
            player.ApplyConditionEffect(ConditionEffectIndex.Invincible);
            player.ApplyConditionEffect(ConditionEffectIndex.Damaging);
            player.ApplyConditionEffect(ConditionEffectIndex.Berserk);
    ...
    class ClearBuffsCommand : Command
    {
        public ClearBuffsCommand() : base("clearbuff", alias: "cbuff", permLevel: 80) { }

        protected override bool Process(Player player, RealmTime time, string args)
        {
            ConditionEffect eff = new ConditionEffect();

            var condition = eff.Effect;
            ConditionEffects conditions = 0;
            conditions |= (ConditionEffects)(1 << (Byte)condition);
            if (condition > 0 || player.HasConditionEffect(conditions))
            {
    ...
    {
        public GuildRankCommand() : base("grank", permLevel: 5) { }
    ...
    {
        public GimmeCommand() : base("gimme", permLevel: 3, alias: "give") { }
    ...
    {
        public TpPosCommand() : base("tpPos", permLevel: 4, alias: "goto") { }
    ...
    {
        public SetpieceCommand() : base("setpiece", permLevel: 4) { }
    ...
    class DebugCommand : Command
    {
        ...
        public DebugCommand() : base("debug", permLevel: 6, listCommand: false) { }
    ...
    {
        public KillAllCommand() : base("killAll", permLevel: 4, alias: "ka") { }
    ...
    {
        public KickCommand() : base("kick", permLevel: 4) { }
    ...
    {
        public GetQuestCommand() : base("getQuest", permLevel: 6) { }
    ...
    {
        public OryxSayCommand() : base("oryxSay", permLevel: 5, alias: "osay") { }
    ...
    {
        public AnnounceCommand() : base("announce", permLevel: 5) { }
    ...
    {
        public SummonCommand() : base("summon", permLevel: 4) { }
    ...
    {
        public SummonAllCommand() : base("summonall", permLevel: 5) { }
    ...
    {
        public KillPlayerCommand() : base("killPlayer", permLevel: 5) { }
    ...
    {
        public SizeCommand() : base("size", permLevel: 4) { }
        ...
        protected override bool Process(Player player, RealmTime time, string args)
        {
            ...
            var min = player.Rank < 80 ? 30 : 0;
            var max = player.Rank < 80 ? 400 : 500;
    ...
    {
        public ReSkinCommand() : base("reskin", permLevel: 2) { }
    ...
    {
        public MaxCommand() : base("max", permLevel: 3) { }
    ...
    {
        public TpQuestCommand() : base("tq", permLevel: 4) { }
    ...
    {
        public RankCommand() : base("rank", permLevel: 6) { }
        ...
        protected override bool Process(Player player, RealmTime time, string args)
        {
            ...
            {
                player.SendInfo("Usage: /rank <player name> <rank>\\n0: Normal Player, 1: Donor, 2: SuperDonor, 3: V2Support, 4: Helper, 5: Admin, 6: Owner");
                return false;
            }
    ...
    class MuteCommand : Command
    {
        ...
        public MuteCommand(RealmManager manager) : base("mute", permLevel: 5)
        {
            _manager = manager;
    ...
    {
        public UnMuteCommand() : base("unmute", permLevel: 5) { }
    ...
    {
        public BanAccountCommand() : base("ban", permLevel: 4) { }
    ...
    {
        public BanIPCommand() : base("banip", permLevel: 5, alias: "ipban") { }
    ...
    {
        public UnBanAccountCommand() : base("unban", permLevel: 5) { }
    ...
    {
        public ClearInvCommand() : base("clearinv", permLevel: 5) { }
    ...
    {
        public MusicCommand() : base("music", permLevel: 4) { }
    ...
    {
        public CloseRealmCommand() : base("closerealm", permLevel: 4) { }
    ...
    {
        public QuakeCommand() : base("quake", permLevel: 4) { }
        ...
        protected override bool Process(Player player, RealmTime time, string worldName)
        {
            ...
            {
                p.SendInfo($"{player.Name} is quaking you to {world.Name}!");
            }
            return true;
        }
    }
    ...
    {
        public VisitCommand() : base("visit", permLevel: 4) { }
    ...
    {
        public HideCommand() : base("hide", permLevel: 1, alias: "h") { }
    ...
    {
        public GlowCommand() : base("glow", permLevel: 3) { }
    ...
    {
        public LinkCommand() : base("link", permLevel: 6) { }
    ...
    {
        public UnLinkCommand() : base("unlink", permLevel: 6) { }
    ...
    {
        public GiftCommand() : base("gift", permLevel: 5) { }
    ...
    {
        public RemovePets() : base("removeAllPets", permLevel: 6) { }
    ...
    {
        public OverrideAccountCommand() : base("override", permLevel: 6) { }
    ...
    {
        public Level20Command(RealmManager manager) : base("level20", permLevel: 1, alias: "l20")
        {
            _manager = manager;
        }
    ...
    {
        public RenameCommand() : base("rename", permLevel: 6) { }
    ...
    {
        public UnnameCommand() : base("unname", permLevel: 6) { }
    ...
    {
        public WargCommand() : base("warg", permLevel: 5) { }
    ...
    {
        public CompactLOHCommand() : base("compactLOH", permLevel: 6, listCommand: false) { }
    ...
    class AddGoldCommand : Command
    {
        public AddGoldCommand() : base("addgold", permLevel: 4, alias: "agold") { }
    ...
    {
        public SetGoldCommand() : base("setgold", permLevel: 4, alias: "gold") { }
    ...
    class AddFameCommand : Command
    {
        public AddFameCommand() : base("addfame", permLevel: 4, alias: "afame") { }
        ...
        protected override bool Process(Player player, RealmTime time, string args)
        {
            ...
            if (string.IsNullOrEmpty(args))
            {
                player.SendInfo("/afame <amount>");
                return false;
            }

            player.CurrentFame = player.Client.Account.Fame += amount2;
    ...
    {
        public SetFameCommand() : base("setfame", permLevel: 4, alias: "fame") { }
    ...
    class SetCharFameCommand : Command
    {
        public SetCharFameCommand() : base("charfame", permLevel: 5, alias: "cfame") { }
    ...
    {
        public SetCommand() : base("set", permLevel: 1) { }

        protected override bool Process(Player player, RealmTime time, string args)
        {
            if (!(player.Owner is Vault))
            {
                player.SendError("This command requires you to be in your vault first.");
                return false;
            }
            else
            {
                Entity en = Entity.Resolve(player.Manager, "setgiver");
    ...
    class SuperSetCommand : Command
    {
        public SuperSetCommand() : base("superset", permLevel: 1) { }
        ...
        protected override bool Process(Player player, RealmTime time, string args)
        {
            ...
            {
                Entity en = Entity.Resolve(player.Manager, "supersetgiver");
                en.Move(player.X, player.Y);
                player.Owner.EnterWorld(en);
                return false;
            }
